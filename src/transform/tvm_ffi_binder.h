 ...
 */
#ifndef TVM_TL_TRANSFORM_TVM_FFI_BINDER_H_
#define TVM_TL_TRANSFORM_TVM_FFI_BINDER_H_
...
/*!
 * \brief Helper utility to generate match, bind, and host ABI checks for
 * packed function arguments.
 *
 * TVMFFIABIBuilder owns DLTensor ABI validation generated by TileLang's
 * MakePackedAPI pass.  Runtime validation failures are emitted as structured
 * AssertStmt nodes so the generated host stub reports errors through the TVM
 * FFI C ABI error slot instead of calling back into packed Python helpers.
 *
...
public:
   ...
   * variables. TVMFFIABIBuilder will update this def_map when adding new
   * definitions.
   */
...
#endif // TVM_TL_TRANSFORM_TVM_FFI_BINDER_H_
