...
def regression_example_tilelang_sparse_gqa_decode_paged():
    tilelang.testing.process_func(
        example_tilelang_sparse_gqa_decode_paged.run_regression_perf, batch=1, max_cache_seqlen=2048, num_pages=128
    )
