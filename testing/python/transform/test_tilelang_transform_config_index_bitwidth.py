    ...
    def kernel_func(block_M, block_N, num_stages, threads):
        ...
        def main(
            ...
            with T.Kernel(T.ceildiv(seq_len, block_M), heads, batch, threads=threads) as (bx, by, bz):
                ...
                # acc_s_cast feeds MMA1 as the A operand. TANG TMMA has no
                # register-source variant, so A must live in shared memory --
                # the same choice the PTPU-aware attention examples make.
