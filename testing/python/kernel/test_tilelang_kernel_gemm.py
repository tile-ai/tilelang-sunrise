...
def _float32_gemm_input_dtype():
    # STCU uses float32 inputs; CUDA and CDNA use tfloat32.
    return T.float32 if _ptpu_is_available() else T.tfloat32
