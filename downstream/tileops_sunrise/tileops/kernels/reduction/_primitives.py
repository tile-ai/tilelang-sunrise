...
# 64-element alignment (512 bytes for fp16/bf16) required by T.copy()
...
def device_smem_budget(device_index: int | None = None) -> int:
    ...
    try:
        ...
        if device_index is None:
            device_index = torch.ptpu.current_device()

        props = torch.ptpu.get_device_properties(device_index)
