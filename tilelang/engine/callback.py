...
def register_tang_postproc(func: Callable[[str, Target], str], override: bool = True):
    """Register a post-processing callback for TANG source generation."""
    tvm_ffi.register_global_func("tilelang_callback_tang_postproc", f=func, override=override)
