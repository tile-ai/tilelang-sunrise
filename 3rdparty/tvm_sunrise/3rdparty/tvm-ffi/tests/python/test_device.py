...
def test_tang_device_type_abi_values() -> None:
    assert int(DLDeviceType.kDLTANG) == 20
    assert int(DLDeviceType.kDLTANGHost) == 21
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("tang:1", DLDeviceType.kDLTANG, 1),
        ("tang_host:2", DLDeviceType.kDLTANGHost, 2),
    ],
)
